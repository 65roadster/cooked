...
ExecuteSQL($conn,
	...
	($RecipeID, 'Wisk eggs, oil, cheese, parsley, salt and pepper in a bowl until it forms a consistent, even color with no unmixed egg whites.'),
	($RecipeID, 'Cook sausage until nearly done (some pink remains, it will finish cooking later), then add garlic and cook until aromatic, about 30 seconds. Stire sausage/garlic into eggs, stirring to avoid cooking any of the eggs.'),
